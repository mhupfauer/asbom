...
- **[ASBOM v0.1 specification](https://github.com/mhupfauer/agent-system-bom/blob/main/profile.md)** — conformance rules, component taxonomy, composition pattern, attestation, signing, property-bag fallback
- **[Proposal: `principal` field](https://github.com/mhupfauer/agent-system-bom/blob/main/proposal-principal-field.md)** — JSON Schema fragment, backwards-compat analysis, full four-axis decomposition, non-repudiation framing, worked diff examples
- **[Worked example ASBOM](https://github.com/mhupfauer/agent-system-bom/blob/main/example-claude-code-session.cdx.json)** — valid CycloneDX 1.7: Claude Code + skill + MCP server + Win11 Agent Workspace, with signed fleet-admin and registry-operator attestations
